...
OBJS += \
./Drivers/Clock/clock.o 

C_DEPS += \
./Drivers/Clock/clock.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Clock/%.o: ../Drivers/Clock/%.c Drivers/Clock/subdir.mk
...
clean: clean-Drivers-2f-Clock

clean-Drivers-2f-Clock:
	-$(RM) ./Drivers/Clock/clock.d ./Drivers/Clock/clock.o

.PHONY: clean-Drivers-2f-Clock
