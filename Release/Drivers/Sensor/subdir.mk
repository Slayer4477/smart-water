...
OBJS += \
./Drivers/Sensor/sensor.o 

C_DEPS += \
./Drivers/Sensor/sensor.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Sensor/%.o: ../Drivers/Sensor/%.c Drivers/Sensor/subdir.mk
...
clean: clean-Drivers-2f-Sensor

clean-Drivers-2f-Sensor:
	-$(RM) ./Drivers/Sensor/sensor.d ./Drivers/Sensor/sensor.o

.PHONY: clean-Drivers-2f-Sensor
