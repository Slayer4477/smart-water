...
Drivers/MQTT/%.o: ../Drivers/MQTT/%.c Drivers/MQTT/subdir.mk
...
clean: clean-Drivers-2f-MQTT

clean-Drivers-2f-MQTT:
	-$(RM) ./Drivers/MQTT/mqtt.d ./Drivers/MQTT/mqtt.o

.PHONY: clean-Drivers-2f-MQTT
